...
public class UserAgent implements DOMNotificationListener, UagentTopicReadService, AutoCloseable{
    ...
    private Properties getDefaultProperties ()
    {
        ...
        //Manually input PaNDA Kafka properties (for testing only)
        props.put("metadata.broker.list", "localhost:9092"); //,173.39.249.30:9093");
        props.put("producer.type", "sync");
        props.put("compression.codec",  "none");
        props.put("serializer.class","kafka.serializer.DefaultEncoder");
        //props.put("group.id",   "odlmsggrp");
        //props.put("topic", "odlmsg");
        return props;
        ...
        if( nodeName != null && topicId != null ){
            ...
            if(registeredTopic.contains(topicId.getValue())){
                ...
                if(payLoadString != null){
                     ...
                     String topic = "odlmsg"; //(String) props.getProperty("topic");
                     LOG.info("topic id obtained: " + topic);
                     String msg = "msg-" + messageId+ ": " + payLoadString;
                     keyedMsg = new KeyedMessage<String, Object>(topic, msg.getBytes());
