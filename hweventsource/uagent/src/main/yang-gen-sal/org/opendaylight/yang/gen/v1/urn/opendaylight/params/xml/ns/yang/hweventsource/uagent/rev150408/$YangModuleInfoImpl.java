...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "hweventsource-uagent";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:hweventsource:uagent";
    private final String revision = "2015-04-08";
    private final String resourcePath = "/META-INF/yang/hweventsource-uagent.yang";
