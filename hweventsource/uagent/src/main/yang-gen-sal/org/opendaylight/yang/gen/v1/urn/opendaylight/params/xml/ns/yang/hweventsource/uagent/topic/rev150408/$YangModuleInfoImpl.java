...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "uagent-topic-read";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:hweventsource:uagent:topic";
    private final String revision = "2015-04-08";
    private final String resourcePath = "/META-INF/yang/uagent-topic-read.yang";
