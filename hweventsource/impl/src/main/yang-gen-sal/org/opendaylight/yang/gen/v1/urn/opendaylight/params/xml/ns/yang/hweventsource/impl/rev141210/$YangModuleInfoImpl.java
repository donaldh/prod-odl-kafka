...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "hweventsource-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:hweventsource:impl";
    private final String revision = "2014-12-10";
    private final String resourcePath = "/META-INF/yang/hweventsource-impl.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.messagebus.spi.eventsourceregistry.rev150402.$YangModuleInfoImpl.getInstance());
